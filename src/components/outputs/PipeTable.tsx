...
import buildPipeTable from "../../tables/functions/buildPipeTable";
...
const PipeTable = (props: PipeTableProps) => {
  const [showFullTable, setShowFullTable] = useState(false);
  const { tableTitle, tableHeader, tableRows } = buildPipeTable(
    showFullTable,
    props.nearestIndex,
    props.table,
    props.outputUnits,
    ...
    <>
      <TableContainer sx={containerStyles}>
        <Table size="small" align="center">
          ...
          <TableHead>
            <TableRow>
              <TableCell align="center" colSpan={3} sx={titleStyles}>
                {tableTitle}
              </TableCell>
            </TableRow>
          </TableHead>
